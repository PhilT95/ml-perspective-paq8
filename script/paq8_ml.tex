...
\begin{frame}{Neural network}
	...
	\begin{itemize}
		\item 1 input layer with $n$ inputs where $n\in\mathbb{N}\setminus\{0\}$
		\item 1 output layer with $k$ inputs where $k\in\mathbb{N}\setminus\{0\}$
		\item $M$ layers between input and output layer with $M\in\mathbb{N}$,
		\item Layers can consist of different amounts of neurons (at least one)
	\end{itemize}
	\end{alertblock}	
	...
	\begin{block}{General structure of neural network}
		...
		\begin{itemize}
			\item $x_1,...x_n$ inputs and $l_1,...,y_k$ outputs
